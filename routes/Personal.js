...
router.get("/", function (req, res, next) {
    ...
    const sql = `SELECT * FROM mt_personal ORDER BY id`;
...
router.get("/:id", function (req, res, next) {
    ...
    const sql = `SELECT * FROM mt_personal WHERE id = ? ORDER BY id`;
...
router.post("/update", (req, res) => {
    ...
    const sql = `UPDATE mt_personal SET name = ?, type = ?, description = ?, status = ?, update_date = ?, update_by= 'Admin'  WHERE id = ?`;
...
router.post("/insert", (req, res) => {
    ...
    const sql = `INSERT INTO mt_personal(name, description, type, status, create_date, create_by) VALUES(?, ?, ?, ?, ?, ?) `;
...
router.post("/remove", (req, res) => {
    ...
    const sql = `DELETE FROM mt_personal WHERE id = ? `;
